...
export const isActor = (actor: Actor | User | null): actor is Actor => actor && typeof actor !== 'undefined';
...
export const isUser = (user: User | Actor | null): user is User => user && typeof user !== 'undefined';
